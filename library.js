...
function Library() {
    ...
    const scrollEditable = () => {
        const newValue = prompt("Enter new scrolling text", scrollData);
        if (newValue !== null) {
    ...
    return ( 
        <div>
             <header>
        <img src={logo} alt='
        ' width="130px" height="130px"></img> <span contenteditable="true">GEETHANJALI INSTITUTE OF SCIENCE AND TECHNOLOGY: NELLORE, AP.</span>
       </header>
